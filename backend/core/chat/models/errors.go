...
var (
	ErrTokenNotFound       = errors.New("jwtauth: нет токена")
	ChatNotFound           = errors.New("[INFO] Нет ни одного чата")
	EmptyMessage           = errors.New("[ERROR] Добавте сообщение")
	EmptyAddMessage        = errors.New("[ERROR] Ошибка...")
	ErrEmptyImage          = errors.New("[ERROR] Нет аватарки")
	ErrUserDoNotHaveAccess = errors.New("[ERROR] Доступ запрещен")
	ErrUserNilAvatar       = errors.New("[ERROR] Нет данных по аватарам")
)
